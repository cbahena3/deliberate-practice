...
if age <= 12
  pp "Your ticket is $5.00"
elsif age >= 13 && age <= 59
  if movieTime < 18
    pp "Your ticket is $7.00"
  else
    pp "Your ticket is $10.00"
  end
elsif age >= 60
  pp "Your ticket is $7.00"
end
...
if bookType == "regular"
  if daysOverdue <= 7
    pp "Your fine is $#{1 * daysOverdue}"
  else daysOverdue > 7
    pp "Your fine is $#{2 * daysOverdue}"
  end
elsif bookType == "reference"
  pp "You have no fine"
elsif bookType == "special collection"
  pp "Your fine is $#{5 * daysOverdue}"
end
...
if orderCost < 50
  pp "No discount for you"
elsif orderCost >= 50 && orderCost <= 100
  if membership == "regular"
    pp "You get a 5% discount"
  elsif membership == "premium"
    pp "You get a 10% discount"
  end
elsif orderCost > 100
  if membership == "regular"
    pp "You get a 10% discount"
  elsif membership == "premium"
    pp "You get a 15% discount"
  end
end
